pipeline {
    ...
    environment {
        NETLIFY_SITE_ID = '1814a42e-e7da-4ffa-98d5-29b75fab7b2b'
    ...
    stages {
        ...
        stage('Approval') {
            steps {
                timeout(time: 15, unit: 'MINUTES'){
                    input message: 'Do you wish to deploy to Prod?', ok: 'Yes, I\'m sure!'
                }
            }
        }
        ...
        stage('Deploy Prod') {
            ...
            environment {
                CI_ENVIRONMENT_URL = 'https://papaya-cactus-12abe7.netlify.app'
            }
